...
"""
    ...
    def get_conversational_meaning(self, text: str) -> Optional[Dict[str, Any]]:
        """Get accurate, concise literary meaning with book/source identification in Tamil only"""
        if not self.is_available:
            return None
            
        try:
            # Enhanced prompt for concise, accurate literary analysis
            conversational_prompt = f"""நீங்கள் ஒரு தமிழ் இலக்கிய வல்லுநர். கீழே கொடுக்கப்பட்ட தமிழ் உரையின் துல்லியமான, சுருக்கமான பொருளை மட்டும் தரவும்.

உரை: "{text}"

**வழிகாட்டுதல்கள்:**
1. இது எந்த நூலிலிருந்து வந்ததா என துல்லியமாக கண்டறியவும் (திருக்குறள், கம்பராமாயணம், புறநானூறு, அகநானூறு, சங்க இலக்கியம், திருவாசகம், தேவாரம், நாலடியார், சிலப்பதிகாரம் போன்றவை)
2. நூலிலிருந்து வந்ததென்றால், **அசல் உரையாசிரியர்கள் கூறிய பொருளை மட்டுமே** குறிப்பிடவும் (பரிமேலழகர், மணக்குடவர், கல்லாடனார், வீரமாமுனிவர்)
3. **பொருள் சுருக்கமாகவும் துல்லியமாகவும் இருக்க வேண்டும் - 2-3 வாக்கியங்கள் மட்டும்**
4. சாதாரண உரை என்றால், நேரடி பொருளை மட்டும் தெளிவாக விளக்கவும்

**கட்டாய JSON வடிவம்:**
{{
  "tamil_meaning": "பொருள்:\\n[அசல் உரையின் துல்லியமான பொருள் 2-3 வாக்கியங்களில்]\\n\\nசுருக்கமாக:\\n[ஒரு வரியில் சாரம்]",
  "source_book": "நூலின் பெயர் அல்லது 'சாதாரண உரை'",
  "chapter_section": "அதிகாரம்/காண்டம் அல்லது 'பொருந்தாது'",
  "verse_number": "பாடல் எண் அல்லது 'பொருந்தாது'",
  "commentary_reference": "உரையாசிரியர் பெயர் அல்லது 'பொருந்தாது'",
...
{{
  "tamil_meaning": "பொருள்:\\nஅகரம் எல்லா எழுத்துகளுக்கும் முதல் என்பது போல, ஆதி பகவன் உலகத்திற்கு முதற்காரணம்.\\n\\nசுருக்கமாக:\\nஎழுத்துக்கு அகரம் முதல் போல, உலகிற்கு ஆதிபகவன் முதல்.",
  "source_book": "திருக்குறள்",
  "chapter_section": "கடவுள் வாழ்த்து",
  "verse_number": "1",
  "commentary_reference": "பரிமேலழகர்",
  "theme": "கடவுளின் முதன்மை",
  "sentiment": "devotional"
}}

**மிக முக்கியம்:** 
- பொருள் சுருக்கமாகவும் துல்லியமாகவும் இருக்க வேண்டும் (2-3 வாக்கியங்கள் மட்டும்)
- அசல் நூல் உரையை மட்டும் பின்பற்றவும் - உங்கள் விளக்கங்களை சேர்க்க வேண்டாம்
