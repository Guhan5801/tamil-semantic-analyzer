...
"""
    ...
    def get_conversational_meaning(self, text: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            conversational_prompt = f"""நீங்கள் ஒரு தமிழ் இலக்கிய வல்லுநர் மற்றும் பொருள் விளக்க நிபுணர். கீழே கொடுக்கப்பட்ட தமிழ் உரையின் துல்லியமான பொருளை விளக்கவும்.

உரை: "{text}"

**முக்கியமான வழிகாட்டுதல்கள்:**
1. இது இலக்கிய நூலிலிருந்து வந்ததா என கண்டறியவும் (திருக்குறள், கம்பராமாயணம், புறநானூறு, அகநானூறு, சங்க இலக்கியம், திருவாசகம், தேவாரம், நாலடியார், சிலப்பதிகாரம் போன்றவை)
2. நூலிலிருந்து வந்ததென்றால், துல்லியமான நூல் பெயர், அதிகாரம்/காண்டம், பாடல் எண் குறிப்பிடவும்
3. **பொருள் இரண்டு பகுதிகளாக இருக்க வேண்டும்:**
   - **பொருள்:** விரிவான விளக்கம் (2-3 வாக்கியங்கள்)
   - **சுருக்கமாக:** ஒரு வரியில் சுருக்கமான பொருள்
4. சாதாரண உரை என்றால், அதன் நேரடி பொருளை தெளிவாக விளக்கவும்
5. வரிக்கு வரி அல்லது சொல்லுக்கு சொல் பொருள் தரவும்

**கட்டாய JSON வடிவம்:**
{{
  "tamil_meaning": "பொருள்:\\n[விரிவான விளக்கம் 2-3 வாக்கியங்களில்]\\n\\nசுருக்கமாக:\\n[ஒரு வரியில் சுருக்கமான பொருள்]",
  ...
  "line_by_line": "ஒவ்வொரு வரியின்/சொல்லின் பொருள் விளக்கம்",
  "explanation": "விரிவான சூழல், பின்னணி, முக்கியத்துவம்",
  "theme": "முக்கிய கருத்து மற்றும் செய்தி",
  "sentiment": "positive/negative/neutral/devotional/philosophical"
}}

**முக்கிய எடுத்துக்காட்டு வடிவம்:**
உதாரணம் உள்ளீடு: "அகர முதல எழுத்தெல்லாம் ஆதி பகவன் முதற்றே உலகு"

tamil_meaning இப்படி இருக்க வேண்டும்:
"பொருள்:
அகரம் எல்லா எழுத்துகளுக்கும் முதல் எழுத்து எனப்படுவது போல, இந்த உலகிற்கும் ஆதியும் முதலும் இறைவனே ஆவான்.

சுருக்கமாக:
எழுத்துகளுக்கு 'அ' முதல் என்பதுபோல, உலகிற்கும் இறைவனே தொடக்கம்."

**கவனிக்க:** 
- tamil_meaning க்குள் கட்டாயம் "பொருள்:" மற்றும் "சுருக்கமாக:" என்ற இரண்டு பகுதிகள் இருக்க வேண்டும்
- பொருள் பகுதி விரிவாகவும் தெளிவாகவும் இருக்க வேண்டும்
- சுருக்கமாக பகுதி ஒரு வரியில் சுருக்கமாக இருக்க வேண்டும்"""
